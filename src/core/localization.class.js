...
class Localization {
	...
	_findPhrase(l10n, namespace, key) {
		if (this._localizations[l10n] === undefined) {
			throw new exception.LocalizationError(l10n);
		}
		if (this._localizations[l10n][namespace] === undefined) {
			throw new exception.PhraseError(l10n, namespace, key);
		}
	...
	_findLocalization(l10n) {
		if (this._localizations[l10n] === undefined) throw new exception.LocalizationError(l10n);
